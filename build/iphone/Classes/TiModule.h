...
/**
 The base class for all Telkom modules
 */
...
/**
 Telkom Platform calls this method on startup.
 */
-(void)startup;

/**
 Telkom Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Telkom Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Telkom Platform calls this method on resume.
 @param sender The sender of the event.
 */
